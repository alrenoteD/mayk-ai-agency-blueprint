...
const Footer: React.FC = () => {
  return (
    <footer className="bg-mayk-dark text-white py-12 px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            ...
            <p className="text-gray-400 mb-6">
              O guia definitivo para criar e escalar sua agência de IA e automação, desde a configuração técnica até estratégias de marketing e vendas.
            </p>
            <Button variant="outline" className="bg-transparent border-mayk-purple text-mayk-purple hover:bg-mayk-purple hover:text-white">
              Iniciar Jornada
            </Button>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {['Início', 'Configuração', 'Integrações', 'Escala', 'Marketing'].map((item) => (
                <li key={item}>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {['Documentação', 'Tutoriais', 'Templates', 'FAQ', 'Suporte'].map((item) => (
                <li key={item}>
